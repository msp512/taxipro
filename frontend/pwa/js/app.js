...
function buildInviteWhatsappMessage(inviteCode) {
  ...
  "",
  "TAXIPRO es una herramienta privada de prueba para ayudar al taxista a calcular una estimación profesional del servicio y, cuando sea posible, registrar el precio final del taxímetro para mejorar la calibración.",
  "",
  "Con la APC 2026, muchos taxis harán servicios fuera de su zona habitual. TAXIPRO puede ayudar a reducir errores de tarifa, mejorar la transparencia con el cliente y recoger datos reales para ajustar mejor los criterios de estimación.",
  "",
  "Acceso:",
  "",
  "1. Abre este enlace:",
  ...
  inviteCode,
  "",
  "3. Escribe tu nombre para poder identificar tu dispositivo.",
  "",
  "4. Pulsa “Activar dispositivo”.",
  "",
  "5. Cuando yo apruebe el acceso, ya podrás usar la app.",
  "",
  "Uso rápido:",
  "",
  "- Origen: punto real donde empieza el servicio o donde se pone en marcha el taxímetro.",
  "- Punto intermedio: solo si hay una parada, recogida previa o paso necesario.",
  "- Destino final: destino solicitado por el cliente.",
  "- Suplementos: marca solo los que correspondan.",
  "- Calcular estimación: muestra precio orientativo, distancia, duración y tarifa aplicada.",
  "- Registrar servicio: al finalizar, introduce el precio real del taxímetro cuando puedas.",
  "",
  "Importante:",
  "TAXIPRO ofrece una estimación profesional. El precio final válido siempre es el que marca el taxímetro.",
  "",
  "Gracias por colaborar en la prueba."
].join("\n");
}
